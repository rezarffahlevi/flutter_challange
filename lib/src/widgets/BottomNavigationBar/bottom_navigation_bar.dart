...
import 'package:flutter_challange/src/widgets/BottomNavigationBar/bottom_curved_Painter.dart';
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? TheColors.primary : Colors.white,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
              ...
              child: Opacity(
                ...
                child: Icon(icon,
                    color: isEnable ? TheColors.white : TheColors.text),
              )),
        ),
      ),
    );
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.chat, _selectedIndex == 2, 2),
